...
export const ProductsManagementPage = () => {
    const { products, loading, error, fetchProducts, createProductWithImage, updateProductWithImage, deleteProduct } = useProducts();
    ...
    useEffect(() => {
        // Solo hacer las peticiones si el usuario está autenticado y tiene los roles correctos
        if (authenticated && (isAdmin || isVendor)) {
            fetchProducts();
            fetchProductCategories();
            fetchSellers();
        }
    }, [authenticated, isAdmin, isVendor]);
...
const CreateProductModal = ({ categories, sellers, onClose, onSubmit }: { 
    categories: any[]; 
    sellers: any[];
    onClose: () => void; 
    ...
    return (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div className="mt-3">
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Crear Producto</h3>
...
const EditProductModal = ({ product, categories, sellers, onClose, onSubmit }: { 
    product: any; 
    categories: any[]; 
    sellers: any[];
    onClose: () => void; 
