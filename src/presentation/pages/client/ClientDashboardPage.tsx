    ...
    const dashboardCards = [
        {
            ...
            description: 'Descubre los productos disponibles',
            icon: (
    ...
    return (
        <div className="bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Módulos principales */}
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">¿Qué quieres hacer hoy?</h2>
                                ...
                                <div className="p-8">
                                    <div className="flex items-center justify-between mb-4">
                                        ...
                                        <div className="text-right">
                                            <span className="text-xl font-bold text-indigo-600">Acceder</span>
                                        </div>
                                    </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        <div className="p-4 border border-blue-200 rounded-md bg-blue-50">
                            <h4 className="font-medium text-blue-900 mb-2">🛒 Compras</h4>
                            <p className="text-sm text-blue-800">
                                Explora nuestro catálogo y realiza pedidos de productos tecnológicos.
                            </p>
                        </div>
                    </div>
                </div>
